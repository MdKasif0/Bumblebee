...
export class SpriteManager {
  ...
  async loadAll(onProgress = () => {}) {
    const assetList = [
      ...
      { key: 'special_igo', url: 'assets/special/text_i_go.png?v=3' },
      { key: 'special_you_go', url: 'assets/special/text_you_go.png?v=3' },
      { key: 'special_boom_1', url: 'assets/special/boom_1.png?v=3' },
      { key: 'special_boom_2', url: 'assets/special/boom_2.png?v=3' },
      { key: 'special_boom_3', url: 'assets/special/boom_3.png?v=3' },
      { key: 'special_zoom_text_1', url: 'assets/special/zoom_text_1.png?v=3' },
      { key: 'special_zoom_text_2', url: 'assets/special/zoom_text_2.png?v=3' },
      { key: 'special_zoom_flame_1', url: 'assets/special/zoom_flame_1.png?v=3' },
      { key: 'special_zoom_flame_2', url: 'assets/special/zoom_flame_2.png?v=3' },
      { key: 'text_know_what', url: 'assets/text_rgba/20_know_what.png?v=3' },
      { key: 'text_want_from_me', url: 'assets/text_rgba/21_want_from_me.png?v=3' },
